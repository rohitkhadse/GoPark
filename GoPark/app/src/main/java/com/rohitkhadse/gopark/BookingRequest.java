...
public class BookingRequest extends StringRequest {
    ...
    public BookingRequest(int hours, Response.Listener<String> listener)
    {
        ...
        int userpoints=100;
        params=new HashMap<>();
        params.put("userid", String.valueOf(GoParkUser.selectedParkLot.getUserId()));
        params.put("lotid",String.valueOf(GoParkUser.selectedParkLot.getID()));
        params.put("rate",String.valueOf(GoParkUser.selectedParkLot.getRate()));

package com.rohitkhadse.gopark.Maps;
...
import com.rohitkhadse.gopark.Account;
import com.rohitkhadse.gopark.Booking;
import com.rohitkhadse.gopark.Login;
import com.rohitkhadse.gopark.GoParkUser;
import com.rohitkhadse.gopark.ParkLotData;
import com.rohitkhadse.gopark.R;
...
import com.rohitkhadse.gopark.RentRequest;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void setMarker(ParkLotData lotData) {
            ...
            else if(lotData.getUserId()==GoParkUser.getUserId())
            ...
            GoParkUser.allMarkersMap.put(marker, lotData);
     }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (mMap != null) {
            ...
            public boolean onMarkerClick(Marker marker) {
                ParkLotData dataLot = GoParkUser.allMarkersMap.get(marker);
                GoParkUser.setSelectedParkLot(dataLot);

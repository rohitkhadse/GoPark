...
import com.rohitkhadse.gopark.Maps.MapsActivity;
                ...
                Response.Listener<String> responseListener = new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            GoParkUser.setUserId(jsonResponse.getInt("userid"));
                            GoParkUser.setEmail(jsonResponse.getString("email"));
                            GoParkUser.setName(jsonResponse.getString("name"));
                            GoParkUser.setUserPoints(jsonResponse.getInt("userpoints"));
                            if (success)
                            {
